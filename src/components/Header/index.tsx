			...
			{canChooseTheme && (
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button
							variant="outline"
							className="flex aspect-square h-10 w-10 cursor-pointer items-center justify-center p-0 shadow-sm"
						>
							<CgSun className="rotate-0 scale-100 text-xl transition-all dark:rotate-90 dark:scale-0" />
